    ...
    return (
        <div className="relative w-full group px-2">
            ...
            <div ref={scrollRef} className="flex gap-2.5 overflow-x-auto no-scrollbar py-2 px-2 scroll-smooth">
                ...
                {userList.map((group, uIdx) => {
                    const firstMedia = group.items[0].MediaUrl;
                    const isVideo = firstMedia?.toLowerCase().match(/\.(mp4|mov|avi|webm|ogg)$/);
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                    <div className="bg-[var(--color-bg)] w-full max-w-md rounded-xl shadow-2xl overflow-hidden border border-gray-700">
                        ...
                        <div className="p-4">
                            ...
                            {/* Preview */}
                            {preview && (
                                <div className="mt-4 h-48 bg-black rounded-lg overflow-hidden relative">
                                    <img src={preview} className="w-full h-full object-contain" alt="Preview" />
                                    {/* Badge video */}
                                    {isVideoPreview && (
                            ...
                            {/* Fallback khi video không tạo được thumbnail */}
                            {!preview && file?.type.startsWith("video/") && (
                                <div className="mt-4 h-48 bg-black rounded-lg overflow-hidden flex items-center justify-center">
